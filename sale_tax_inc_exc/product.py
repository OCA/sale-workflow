...
class PriceType(orm.Model):
    ...
    _columns = {
        'field_price_inc': fields.selection(
...
class ProductProduct(orm.Model):
    ...
    def price_get(self, cr, uid, ids, ptype='list_price', context=None):
        ...
        if 'tax_inc' in context:
            ...
            price_type = price_type_obj.browse(
                cr, uid, price_type_id[0], context=context)
            if context['tax_inc']:
        ...
        return super(ProductProduct, self).\
            price_get(cr, uid, ids, ptype=ptype, context=context)
    ...
    def create(self, cr, uid, vals, context=None):
        create_id = super(ProductProduct, self).create(cr, uid, vals, context=context)
