...
class TestSaleCrmSetWon(common.SavepointCase):
    ...
    def test_set_won_1(self):
        ...
        self.env['ir.config_parameter'].sudo().set_param("crm_set_won",
                                                         True)
        self.env['ir.config_parameter'].sudo().set_param("crm_set_won_option",
                                                         'choose_stage')
        self.env['ir.config_parameter'].sudo().set_param("stage_id",
                                                         crm_stage_won)
