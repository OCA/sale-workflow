...
class SaleOrder(models.Model):
    ...
    def write(self, values):
        ...
        crm_set_won_option = self.env['ir.config_parameter'].sudo().get_param(
            'sale_crm_set_won.crm_set_won_option')

        stage_id = self.env['ir.config_parameter'].sudo().get_param(
            'sale_crm_set_won.stage_id')
