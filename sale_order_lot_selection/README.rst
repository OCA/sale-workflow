...
.. 
   ...
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! source digest: sha256:cdbdcded95d8d961d7ce20803bd78970babd8c004a623bc5112b4ae560717b84
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
.. |badge3| image:: https://img.shields.io/badge/github-OCA%2Fsale--workflow-lightgray.png?logo=github
    :target: https://github.com/OCA/sale-workflow/tree/19.0/sale_order_lot_selection
    :alt: OCA/sale-workflow
.. |badge4| image:: https://img.shields.io/badge/weblate-Translate%20me-F47D42.png
    :target: https://translation.odoo-community.org/projects/sale-workflow-19-0/sale-workflow-19-0-sale_order_lot_selection
...
Lots can also be selected from the availability popover of each order
line, which shows the available quantity and expiration date of each lot
and allows splitting the line by lot.

The selected lot (and its expiration date, when available) is shown on
the sale order report and on the customer portal.
...
`feedback <https://github.com/OCA/sale-workflow/issues/new?body=module:%20sale_order_lot_selection%0Aversion:%2019.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `OCA/sale-workflow <https://github.com/OCA/sale-workflow/tree/19.0/sale_order_lot_selection>`_ project on GitHub.
