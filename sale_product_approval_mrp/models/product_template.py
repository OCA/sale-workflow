...
class ProductTemplate(models.Model):
    ...
    candidate_manufacture = fields.Boolean(string="Candidate to Manufacture")
    ...
    def write(self, vals):
        ...
        if (
            ...
            or "candidate_manufacture" in vals
            or "candidate_component_manufacture" in vals
            or "candidate_bom" in vals
        ):
            self._set_mrp_ok()
            self._set_mrp_component_ok()
            self._set_bom_ok()
        return res
