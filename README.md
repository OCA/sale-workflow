...
[sale_discount_display_amount](sale_discount_display_amount/) | 16.0.1.2.0 |  | This addon intends to display the amount of the discount computed on sale_order_line and sale_order level
