...
[sale_attached_product](sale_attached_product/) | 18.0.1.0.0 | <a href='https://github.com/chienandalu'><img src='https://github.com/chienandalu.png' width='32' height='32' style='border-radius:50%;' alt='chienandalu'/></a> | Define products that will be added automatically when adding another in a sales order
[sale_automatic_workflow](sale_automatic_workflow/) | 18.0.1.3.0 |  | Sale Automatic Workflow
...
[sale_automatic_workflow_payment_mode](sale_automatic_workflow_payment_mode/) | 18.0.1.0.0 |  | Sale Automatic Workflow - Payment Mode
...
[sale_automatic_workflow_stock](sale_automatic_workflow_stock/) | 18.0.1.0.1 |  | Sale Automatic Workflow Stock
...
[sale_cancel_confirm](sale_cancel_confirm/) | 18.0.1.0.0 | <a href='https://github.com/kittiu'><img src='https://github.com/kittiu.png' width='32' height='32' style='border-radius:50%;' alt='kittiu'/></a> | Sales Cancel Confirm
...
[sale_exception](sale_exception/) | 18.0.2.3.2 |  | Custom exceptions on sale order
...
[sale_invoice_delivery_state](sale_invoice_delivery_state/) | 18.0.1.0.0 |  | Sale Invoice Delivery State
...
[sale_no_portal_button](sale_no_portal_button/) | 18.0.1.0.0 |  | No record access button in sale notification for portal users
...
[sale_order_line_sequence](sale_order_line_sequence/) | 18.0.1.3.0 |  | Propagates SO line sequence to invoices and stock picking.
...
[sale_order_lot_selection](sale_order_lot_selection/) | 18.0.1.4.3 | <a href='https://github.com/bodedra'><img src='https://github.com/bodedra.png' width='32' height='32' style='border-radius:50%;' alt='bodedra'/></a> | Sale Order Lot Selection
...
[sale_order_product_recommendation_secondary_unit](sale_order_product_recommendation_secondary_unit/) | 18.0.1.0.0 |  | Add secondary unit to recommend products wizard
[sale_order_qty_change_no_recompute](sale_order_qty_change_no_recompute/) | 18.0.1.0.0 | <a href='https://github.com/victoralmau'><img src='https://github.com/victoralmau.png' width='32' height='32' style='border-radius:50%;' alt='victoralmau'/></a> | Prevent recompute if only quantity has changed in sale order line
...
[sale_order_warehouse_header](sale_order_warehouse_header/) | 18.0.1.0.0 |  | Moves warehouse field in sales orders form to header, so it becomes more accessible. Improvements in the search view: - Filter by warehouse. - Group by warehouse.
...
[sale_payment_sheet](sale_payment_sheet/) | 18.0.1.0.1 | <a href='https://github.com/sergio-teruel'><img src='https://github.com/sergio-teruel.png' width='32' height='32' style='border-radius:50%;' alt='sergio-teruel'/></a> | Allow to create invoice payments to commercial users without accounting permissions
[sale_planner_calendar](sale_planner_calendar/) | 18.0.1.1.0 | <a href='https://github.com/carlosdauden'><img src='https://github.com/carlosdauden.png' width='32' height='32' style='border-radius:50%;' alt='carlosdauden'/></a> | Sale planner calendar
...
[sale_production_state](sale_production_state/) | 18.0.1.0.0 |  | Show the production state on the sale order
...
[sale_stock_picking_validation_blocking](sale_stock_picking_validation_blocking/) | 18.0.1.0.0 |  | This module adds the opportunity to prevent the validation of delivery order from the SO.
...
[sale_timesheet_project_manual](sale_timesheet_project_manual/) | 18.0.1.0.0 |  | Allows to create the project/tasks before the sale confirmation
