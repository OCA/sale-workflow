...
[sale_order_carrier_auto_assign](sale_order_carrier_auto_assign/) | 15.0.1.0.0 |  | Auto assign delivery carrier on sale order confirmation
...
[sale_order_product_recommendation](sale_order_product_recommendation/) | 15.0.1.0.0 |  | Recommend products to sell to customer based on history
...
[sale_payment_sheet](sale_payment_sheet/) | 15.0.1.1.0 | [![sergio-teruel](https://github.com/sergio-teruel.png?size=30px)](https://github.com/sergio-teruel) | Allow to create invoice payments to commercial users without accounting permissions
