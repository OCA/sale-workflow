...
--- | --- | ---
[product_supplierinfo_for_customer_sale](product_supplierinfo_for_customer_sale/) | 14.0.1.0.0 | Loads in every sale order line the customer code defined in the product
