...
[sale_packaging_default](sale_packaging_default/) | 16.0.1.1.0 | [![yajo](https://github.com/yajo.png?size=30px)](https://github.com/yajo) | Set a default product packaging and simplify its usage in sales orders
