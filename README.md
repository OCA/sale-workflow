...
[sale_invoice_plan](sale_invoice_plan/) | 14.0.1.0.3 | [![kittiu](https://github.com/kittiu.png?size=30px)](https://github.com/kittiu) | Add to sales order, ability to manage future invoice plan
...
[sale_order_general_discount_triple](sale_order_general_discount_triple/) | 14.0.1.0.1 | [![ashishhirapara](https://github.com/ashishhirapara.png?size=30px)](https://github.com/ashishhirapara) | General discount per sale order with triple
...
[sale_procurement_group_by_line](sale_procurement_group_by_line/) | 14.0.1.0.1 |  | Base module for multiple procurement group by Sale order
