...
[product_form_sale_link](product_form_sale_link/) | 13.0.1.0.2 |  | Adds a button on product forms to access Sale Lines
...
[sale_order_type](sale_order_type/) | 13.0.1.7.4 |  | Sale Order Type
...
[sale_payment_sheet](sale_payment_sheet/) | 13.0.1.3.0 | [![sergio-teruel](https://github.com/sergio-teruel.png?size=30px)](https://github.com/sergio-teruel) | Allow to create invoice payments to commercial users without accounting permissions
