...
[sale_elaboration](sale_elaboration/) | 15.0.3.2.1 |  | Set an elaboration for any sale line
...
[sale_order_line_price_history](sale_order_line_price_history/) | 15.0.1.0.1 |  | Sale order line price history
...
[sale_order_product_recommendation](sale_order_product_recommendation/) | 15.0.1.2.1 |  | Recommend products to sell to customer based on history
...
[sale_payment_sheet](sale_payment_sheet/) | 15.0.1.2.1 | [![sergio-teruel](https://github.com/sergio-teruel.png?size=30px)](https://github.com/sergio-teruel) | Allow to create invoice payments to commercial users without accounting permissions
[sale_planner_calendar](sale_planner_calendar/) | 15.0.1.3.4 |  | Sale planner calendar
