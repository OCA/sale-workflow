...
[sale_automatic_workflow](sale_automatic_workflow/) | 13.0.1.1.0 | Sale Automatic Workflow
...
[sale_fixed_discount](sale_fixed_discount/) | 13.0.1.0.1 | Allows to apply fixed amount discounts in sales orders.
[sale_force_invoiced](sale_force_invoiced/) | 13.0.1.0.1 | Allows to force the invoice status of the sales order to Invoiced
...
[sale_order_product_availability_inline](sale_order_product_availability_inline/) | 13.0.1.1.0 | Show product availability in sales order line product drop-down.
...
[sale_order_type](sale_order_type/) | 13.0.1.3.2 | Sale Order Type
...
[sale_product_set](sale_product_set/) | 13.0.1.0.1 | Sale product set
...
[sales_team_security](sales_team_security/) | 13.0.1.0.0 | New group for seeing only sales channel's documents
