...
[sale_order_line_chained_move](sale_order_line_chained_move/) | 15.0.1.0.1 | <a href='https://github.com/rousseldenis'><img src='https://github.com/rousseldenis.png' width='32' height='32' style='border-radius:50%;' alt='rousseldenis'/></a> | This module adds a field on sale order line to get all related move lines
...
[sale_order_mass_action](sale_order_mass_action/) | 15.0.1.0.0 |  | Allows to easy mass operations on sale orders.
...
[sale_planner_calendar](sale_planner_calendar/) | 15.0.4.0.3 |  | Sale planner calendar
...
[sale_stock_warehouse_partner](sale_stock_warehouse_partner/) | 15.0.1.0.0 |  | Allows to set a warehouse to a partner
