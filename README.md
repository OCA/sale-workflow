...
[sale_automatic_workflow](sale_automatic_workflow/) | 14.0.1.3.2 |  | Sale Automatic Workflow
...
[sale_order_partner_restrict](sale_order_partner_restrict/) | 14.0.1.0.0 | [![OriolVForgeFlow](https://github.com/OriolVForgeFlow.png?size=30px)](https://github.com/OriolVForgeFlow) | Apply restrictions when selecting from the list of customers on SO.
