...
[sale_global_discount](sale_global_discount/) | 14.0.1.0.0 |  | Sale Global Discount
...
[sale_order_line_initial_quantity](sale_order_line_initial_quantity/) | 14.0.1.0.0 |  | Allows to display the initial quantity when the quantity has been modified on the command line.
...
[sale_partner_approval](sale_partner_approval/) | 14.0.1.0.0 | [![dreispt](https://github.com/dreispt.png?size=30px)](https://github.com/dreispt) | Control Partners that can be used in Sales Orders
...
[sale_procurement_group_by_line](sale_procurement_group_by_line/) | 14.0.1.0.0 |  | Base module for multiple procurement group by Sale order
...
[sale_product_set](sale_product_set/) | 14.0.1.5.2 |  | Sale product set
