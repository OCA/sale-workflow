...
[sale_pricelist_from_commitment_date](sale_pricelist_from_commitment_date/) | 14.0.1.0.0 | Use sale order commitment date to compute line price from pricelist
