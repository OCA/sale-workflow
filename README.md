...
[product_supplierinfo_for_customer_elaboration](product_supplierinfo_for_customer_elaboration/) | 15.0.1.0.0 |  | Allows to define default elaborations and elaboration notes on product customerinfos
...
[sale_commercial_partner](sale_commercial_partner/) | 15.0.1.0.1 | [![alexis-via](https://github.com/alexis-via.png?size=30px)](https://github.com/alexis-via) | Add stored related field 'Commercial Entity' on sale orders
