...
[sale_invoice_plan](sale_invoice_plan/) | 15.0.1.0.1 | [![kittiu](https://github.com/kittiu.png?size=30px)](https://github.com/kittiu) | Add to sales order, ability to manage future invoice plan
...
[sale_sourced_by_line](sale_sourced_by_line/) | 15.0.1.0.0 |  | Multiple warehouse source locations for Sale order
