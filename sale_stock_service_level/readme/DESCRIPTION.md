...
This service level is used while calling the procurement method while
confirming the sale order and propagated to stock.move in order to apply
rule or reservation rule on it.
