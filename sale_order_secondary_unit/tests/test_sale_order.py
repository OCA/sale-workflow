...
>>>>>>> ba4f2a6c3 (add secondary price unit)
    ...
    def test_default_secondary_unit(self):
<<<<<<<< HEAD:sale_order_secondary_unit/tests/test_sale_order_secondary_unit.py
        self.order.order_line.onchange_secondary_unit_product_id()
        self.assertEqual(self.order.order_line.secondary_uom_id, self.secondary_unit)
        self.order.order_line.product_id_change()
|||||||| parent of fc86c0ab6 ([MIG] sale_order_secondary_unit: Migration to 17.0):sale_order_secondary_unit/tests/test_sale_order_secondary_unit.py
        self.order.order_line.product_id_change()
========
        self.order.order_line._onchange_product_id_warning()
>>>>>>>> fc86c0ab6 ([MIG] sale_order_secondary_unit: Migration to 17.0):sale_order_secondary_unit/tests/test_sale_order.py
        self.assertEqual(self.order.order_line.secondary_uom_id, self.secondary_unit)
