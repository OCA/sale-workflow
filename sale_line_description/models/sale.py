...
class SaleOrderLine(models.Model):
    ...
    def product_id_change(
        self, pricelist, product_id, qty=0, uom=False,
        qty_uos=0, uos=False,
        ...
        if product_id:
            ...
            user = self.env.user
            group_id = self.env.ref('sale_line_description.group_use_product'
                                    '_description_per_so_line')
            if user in group_id.users:
