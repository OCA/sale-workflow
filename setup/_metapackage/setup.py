...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo11-addon-sale_global_discount',
        ...
        'odoo11-addon-sale_order_product_recommendation_secondary_unit',
        ...
        'odoo11-addon-sale_product_multi_add',
        ...
        'odoo11-addon-sale_stock_picking_blocking_proc_group_by_line',
        ...
        'odoo11-addon-sale_timesheet_lock_invoiced',
        'odoo11-addon-sale_timesheet_project_link',
