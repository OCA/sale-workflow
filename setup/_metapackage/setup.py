...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo-addon-sale_cancel_confirmed_invoice>=15.0dev,<15.1dev',
        ...
        'odoo-addon-sale_elaboration_brand>=15.0dev,<15.1dev',
        ...
        'odoo-addon-sale_order_amount_to_invoice>=15.0dev,<15.1dev',
        ...
        'odoo-addon-sale_order_mass_action>=15.0dev,<15.1dev',
