...
class SaleOrder(models.Model):
    ...
    allowed_product_tmpl_ids = fields.Many2many(
        ...
        string="Allowed Products Template",
        compute="_compute_product_assortment_ids",
    )
    ...
    def _compute_product_assortment_ids(self):
        ...
        self.allowed_product_tmpl_ids = False
        ...
        if partner:
            ...
            for ir_filter in filters_partner_domain.filtered(
                lambda f, partner=self[partner_field]: partner.id
            ...
            if product_domain:
                ...
                self.allowed_product_tmpl_ids = self.allowed_product_ids.mapped(
                    "product_tmpl_id"
                )
